...
public:
    ...
    EdtList()
    {
        ...
        thres_map["Dura"] = vector<double>{0.25, 0.5};
        thres_map["TMJ"] = vector<double>{1.0,1.0};
        thres_map["EAC"] = vector<double>{0.25,0.5};
        thres_map["ICA"] = vector<double>{1.0,1.0};
        thres_map["Malleus"] = vector<double>{1.0,1.0};
        thres_map["Incus"] = vector<double>{0.25,0.5};
        ...
        thres_map["Facial_Nerve"] = vector<double>{0.1,0.25};
        thres_map["Chorda_Tympani"] = vector<double>{0.1,0.25};
