...
class Ui(QtWidgets.QWidget):
    def __init__(self):
        ...
        button1 = QtWidgets.QRadioButton("1: Baseline")
        button2 = QtWidgets.QRadioButton("2: Visual only")
        button3 = QtWidgets.QRadioButton("3: Audio only")
        button4 = QtWidgets.QRadioButton("4: Force only")
        button5 = QtWidgets.QRadioButton("5: All assistance")
        self.volumes_grid.addWidget(button1, 11, 0)
        self.volumes_grid.addWidget(button2, 11, 1)
        self.volumes_grid.addWidget(button3, 11, 2)
        self.volumes_grid.addWidget(button4, 12, 0)
        self.volumes_grid.addWidget(button5, 12, 1)
        ...
        button4.clicked.connect(self.radio_button_condition_selection)
        button5.clicked.connect(self.radio_button_condition_selection)
    ...
    def pressed_start_simulation(self):
        ...
        # args = ['--launch_file', str(self.gui_params.launch_file), '-l', launch_file_adf_indices, '-a', self.active_volume_adf, '--edt', self.active_sdf_path, '--condition', self.condition]
        args = ['--launch_file', str(self.gui_params.launch_file), '-l', launch_file_adf_indices, '-a', self.active_volume_adf, '--edt', self.active_sdf_path, '--condition', self.condition, "--unit", str(self.unit), "--spacial_resolution", str(self.spacial_resolution)]
    ...
    def radio_button_condition_selection(self):
        ...
        button4 = QtWidgets.QRadioButton("4: Force only")
        button5 = QtWidgets.QRadioButton("5: All assistance")
        if (button.text() == "1: Baseline"):
            self.condition = '1'
        if (button.text() == "2: Visual only"):
            self.condition = '2'
        if (button.text() == "3: Audio only"):
            self.condition = '3'
        if (button.text() == "4: Force only"):
            self.condition = '4'
        if (button.text() == "5: All assistance"):
            self.condition = '5'
